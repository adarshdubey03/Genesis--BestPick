...
function extendMaterial<T extends THREE.Material = THREE.Material>(
  ...
  if ('roughness' in defaults) uniforms.roughness.value = (defaults as any).roughness ?? uniforms.roughness.value;
  if ('metalness' in defaults) uniforms.metalness.value = (defaults as any).metalness ?? uniforms.metalness.value;
